...
namespace ConvaysGameOfLife
{
	public partial class RandomSeedGenerator
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget ConvaysGameOfLife.RandomSeedGenerator
			this.Name = "ConvaysGameOfLife.RandomSeedGenerator";
			this.Title = global::Mono.Unix.Catalog.GetString ("RandomSeedGenerator");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Container child ConvaysGameOfLife.RandomSeedGenerator.Gtk.Container+ContainerChild
			...
			this.hbox2.Add (this.entryDensity);
			global::Gtk.Box.BoxChild w2 = ((global::Gtk.Box.BoxChild)(this.hbox2 [this.entryDensity]));
			w2.Position = 1;
			...
			this.Show ();
			this.button1.Clicked += new global::System.EventHandler (this.buttonAccept_onClick);
			this.button2.Clicked += new global::System.EventHandler (this.buttonCancel_onClick);
		}
	}
}
